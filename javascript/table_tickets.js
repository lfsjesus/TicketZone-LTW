            ...
            if (response.tickets.length > 0) {
                ...
                tickets.forEach(ticket => {
                    ...
                    tr.innerHTML = `
                        ...
                        <td rowspan="2" class="table-title"><a href="user_profile.php?id=${ticket.ticketAssignee.id}">${ticket.ticketAssignee != null ? ticket.ticketAssignee.firstName + ' ' + ticket.ticketAssignee.lastName : ''}</td>
